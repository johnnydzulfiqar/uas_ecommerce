...
@endif
        <div class="container-fluid">
                ...
                <div class="d-md-flex justify-content-between align-items-center">
                    <h5 class="mb-0">Kategori {{ $user->kategori_produk }}</h5>
                    ...
                    <div class="row align-items-center">
                        <div class="col-lg-4 col-md-5">
                            <div class="mb-3 row">
                                ...
                                <div class="col-sm-5">
                                @if(!empty(@$user->foto_produk))
                                <img src="{{ $user->foto_produk }}" class="mb-3" alt="foto" width="240px" />
                                @endif    
                                </div>
                            </div>
                        ...
                        <div class="col-lg-8 col-md-7 mt-4 mt-sm-0">
                            <div class="section-title ms-md-4">
                                <h5>{{ $user->nama_produk }}</h5>
                                <div class="d-md-flex justify-content-between align-items-center">
                                    <h6 class="text-muted mb-0">{{ $user->harga_produk }} </h6>
                                ...
                                <div class="row mt-4">
                                    ...
                                    <div class="col-lg-6 col-12 mt-4 mt-lg-0">
                                        <div class="d-flex shop-list align-items-center">
                                            <h6 class="mb-0">Quantity: {{ $user->stok }}</h6>
